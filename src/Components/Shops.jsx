    ...
    <div className='shops-container'>
        ...
        <div className='shop-container'>
            <div className="shop-card-container">
                        <div className="upper-part">
                            <div className='pharmacy-name'><i className='fas fa-home'></i> some text <span className='text-orange-300 rating-text'><i className='fa fa-star ml-4 rating'></i>4.5</span></div>
                            <div className="location"><i className='fa-solid fa-location-dot'></i>2.4km some text</div>
                        </div>
                        <div className="middle-part">
                            <div className="operation">
                            <i className='fa fa-clock'></i>Open 24/7
                            ...
                            <div className="delivery"><i className='fa fa-truck-medical'></i>Delivery: 30min . 3000 FCFA</div>
                            <div className="contact"><i className='fa fa-user'></i>phone number</div>
                        </div>
                        <div className="lower-part">
                            <div>
                                <button 
            ...
            <div className="shop-card-container">
                        <div className="upper-part">
                            <div className='pharmacy-name'><i className='fas fa-home'></i> some text <span className='text-orange-300'><i className='fa fa-star ml-4'></i>4.5</span></div>
                            <div className="location"><i className='fa-solid fa-location-dot'></i>2.4km some text</div>
                        </div>
                        <div className="middle-part">
                            <div className="operation">
            ...
            <div className="shop-card-container">
                        <div className="upper-part">
                            <div className='pharmacy-name'><i className='fas fa-home'></i> Pharmacy Mandela <span className='text-orange-300'><i className='fa fa-star ml-4'></i>4.5</span></div>
                            <div className="location"><i className='fa-solid fa-location-dot'></i>2.4km some text</div>
                        </div>
                        <div className="middle-part">
                            <div className="operation">
